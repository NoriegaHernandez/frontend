              ...
              <div className="coach-info">
                ...
                <div className="coach-content">
                  ...
                  <div className="coach-details">
                    ...
                    <p><strong>Especialidad:</strong> {coaches[currentCoach].especialidad || 'No especificada'}</p>
                    
                    {coaches[currentCoach].certificaciones && (
                      <p><strong>Certificaciones:</strong> {coaches[currentCoach].certificaciones}</p>
                    )}
                    
                    {/* Destacar la biografía del coach */}
                    <div className="coach-bio">
                      <h4>Biografía:</h4>
                      {coaches[currentCoach].biografia ? (
                        <p className="bio-text">{coaches[currentCoach].biografia}</p>
                      ) : (
                        <p className="bio-text-empty">Este entrenador no ha añadido su biografía todavía.</p>
                      )}
                    </div>
                  </div>
