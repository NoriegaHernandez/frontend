...
//       console.log("clientId parameter:", clientId); // Debug log
//       console.log("isForSpecificClient:", isForSpecificClient); // Debug log
...
//       console.log("Available clients:", clientsList); // Debug log

//       // Si hay un ID de cliente específico, buscar ese cliente
//       if (clientId !== 'new') {
//         console.log("Looking for client with ID:", clientId); // Debug log
        
//         // Asegurarse de que la comparación sea de string a string o número a número
//         const client = clientsList.find(c => c.id_usuario.toString() === clientId.toString());
...
//         } else {
//           // Si no se encuentra, mostrar error
//           console.error("Client not found in available clients list"); // Debug log
//           setError('Cliente no encontrado o no asignado a este entrenador');
//         }
//       }
...
//     // Determine client ID based on either URL parameter or selected client
//     let finalClientId = null;
    
//     if (clientId !== 'new' && clientId) {
//       // If clientId is in URL and not 'new', use that
...
//       // If creating for specific client based on dropdown selection
...
//     const routineData = {
//       ...formData,
//       // If it's for a specific client, include the client ID
