...
const RoutinesManagement = () => {
    ...
    // Nuevo estado para los días de entrenamiento
    ...
    // Manejador de cambio para los checkboxes de días
    ...
    // Función para obtener un array con los días seleccionados
    ...
    // Función actualizada para asignar rutina con días
    const handleAssignRoutine = async () => {
        ...
        if (selectedDaysArray.length === 0) {
            setNotification({
                type: 'error',
                message: 'Debes seleccionar al menos un día para la rutina'
            });
            return;
        }
        ...
        try {
            ...
            console.log("días seleccionados:", selectedDaysArray);
            ...
            // Llamar a la API actualizada que incluye los días
            await api.assignRoutineToClientWithDays(clientId, routineId, selectedDaysArray);

            setNotification({
                type: 'success',
                message: 'Rutina asignada correctamente para los días seleccionados'
            });
        ...
        <div className="container">
            ...
            <div className="main-content">
                <div className="content-wrapper">
                    ...
                    {/* Modal para asignar rutina con días de la semana */}
                    {showAssignModal && (
                        <div className="modal-overlay">
                            <div className="assign-modal">
                                <div className="modal-header">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="modal-info">
                                        <p>La nueva rutina reemplazará cualquier rutina activa que tenga el cliente.</p>
                                        <p>Por favor, selecciona los días en que el cliente debe realizar esta rutina.</p>
                                    </div>
                                </div>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button
                                        className="assign-button"
                                        onClick={handleAssignRoutine}
                                        disabled={!selectedClientId || !selectedRoutineId || getSelectedDaysArray().length === 0 || assigningRoutine}
                                    >
                                        {assigningRoutine ? 'Asignando...' : 'Asignar Rutina'}
                                    </button>
                                </div>
