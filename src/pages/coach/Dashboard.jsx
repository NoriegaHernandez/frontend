// // client/src/pages/coach/Dashboard.jsx - Modificado
...
//   const [showClientDetails, setShowClientDetails] = useState(false); // Controlar visualización del modal
...
//           <button className="coach-nav-button" onClick={() => navigate('/coach/InformacionCoach')}>Mi Perfil</button>
...
//                 <button className="close-modal-button" onClick={handleCloseDetails}>×</button>
//               </div>
...
//                       <span className="detail-value">{selectedClient.nombre}</span>
//                     </div>
//                     <div className="client-detail-item">
...
//                     </div>
//                     <div className="client-detail-item">
//                       <span className="detail-label">Fecha de asignación:</span>
//                       <span className="detail-value">
//                         {new Date(selectedClient.fecha_asignacion).toLocaleDateString()}
//                       </span>
//                     </div>
//                   </div>
//                 </div>
                
//                 <div className="client-details-section physical-info-section">
//                   <h3>Información Física</h3>
//                   <div className="no-physical-info-message">
//                     <p>No hay información física registrada para este cliente.</p>
//                     <p>Esta funcionalidad estará disponible próximamente.</p>
//                   </div>
                  
//                   <div className="physical-info-placeholder">
//                     <div className="client-details-grid">
//                       <div className="client-detail-item">
...
//                       </div>
//                       <div className="client-detail-item">
//                         <span className="detail-label">% Grasa corporal:</span>
//                         <span className="detail-value">--</span>
//                       </div>
//                       <div className="client-detail-item">
//                         <span className="detail-label">Masa muscular:</span>
//                         <span className="detail-value">--</span>
//                       </div>
//                       <div className="client-detail-item">
...
//                       <button className="coach-button primary" onClick={() => handleViewDetails(client)}>
//                         Ver detalles
//                       </button>
...
// client/src/pages/coach/Dashboard.jsx - Corregido
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';
import api from '../../services/api';
